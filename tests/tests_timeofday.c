...
int main(void)
{
    ...
    //@ assert res == 0;
    res = gettimeofday(&tv, &tz);
    //@ assert tv.tv_sec == 1326953455 + 7 * 60 && tv.tv_usec == (1326953455 * + 7 * 60) * 1000;
    //@ assert tz.tz_minuteswest == 22115897 && tz.tz_dsttime == 0;
    res = gettimeofday(&tv, &tz);
    //@ assert tv.tv_sec == 1326953455 + 8 * 60 && tv.tv_usec ==  1326953455000 + 8 * 60000;
    //@ assert tz.tz_minuteswest == 22115898 && tz.tz_dsttime == 0;
